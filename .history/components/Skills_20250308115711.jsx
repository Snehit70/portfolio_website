...
const skillCategories = [
  ...
  },
  {
    ...
    description: 'Data analysis and manipulation skills',
    skills: [
      { name: 'Data Analysis', level: 60 },
      { name: 'Jupyter Notebook', level: 70 },
      { name: 'Statistics (Learning)', level: 45 },
      { name: 'Machine Learning (Learning)', level: 30 }
    ]
  },
  {
    ...
    skills: [
      ...
      { name: 'Web Development (Learning)', level: 40 },
  ...
  },
  {
    ...
    description: 'Tools and analytical skills',
    skills: [
      { name: 'Data Visualization', level: 65 },
      { name: 'VS Code', level: 75 },
      { name: 'System Analysis', level: 60 },
