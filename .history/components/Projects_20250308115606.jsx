...
const projects = [
  ...
  },
  {
    ...
    description: 'Data analysis project exploring Netflix content trends and patterns using Python and data analysis libraries.',
  ...
  {
    title: 'Pure Battery Analytics',
    description: 'Contributed to a Windows battery analytics application that provides detailed battery statistics and optimization suggestions.',
    image: '/images/projects/battery-analytics.jpg',
    tags: ['System Tools', 'Analytics', 'Windows'],
    githubUrl: 'https://github.com/Snehit70/Pure-Battery-Analytics',
    highlights: ['Battery Monitoring', 'Performance Analytics', 'System Integration']
  }
];
